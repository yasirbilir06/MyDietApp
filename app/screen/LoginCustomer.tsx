...
export default function LoginCustomer() {
  ...
  // Google ile girişte rol kontrolü
  useEffect(() => {
      ...
      signInWithCredential(auth, credential)
        .then(async (userCredential) => {
          ...
          if (userDoc.exists()) {
            ...
            if (data.role !== 'danisan') {
              Alert.alert('Hata', 'Bu hesap danışan hesabı değildir!');
              return;
            }
          } else {
          ...
          // Firebase'den token alıp, "danisanToken" anahtarıyla saklıyoruz
  ...
  // E-posta/Şifre ile girişte rol kontrolü
  ...
  return (
    <View style={styles.container}>
      <Text style={styles.title}>Login Danışan</Text>
